      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Manage your transcriptions and API access
          </p>
        </div>

        {/* Demo Notice */}
        <div className="mb-8 rounded-xl bg-accent/10 border border-accent/20 p-4">
          <p className="text-sm text-muted-foreground">
            <span className="font-medium text-accent">Demo Mode:</span> This dashboard shows sample data. Connect a database to enable full functionality.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 mb-8">
          ...
          <div className="flex items-center gap-4">
            <code className="flex-1 rounded-lg bg-secondary px-4 py-3 font-mono text-sm">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Use this key to authenticate your API requests. See the{" "}
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="space-y-4">
            {[
              { name: "meeting-recording.mp3", date: "2 hours ago", duration: "45:32" },
              { name: "interview-final.wav", date: "Yesterday", duration: "32:15" },
              { name: "podcast-ep-42.mp3", date: "3 days ago", duration: "58:47" },
            ].map((item, i) => (
              <div
                key={i}
